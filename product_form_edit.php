...
$result2 = mysqli_query($con, $sql) or die ("Error in query: $sql " . mysqli_error($LINK));
...
<div class="container">
  <div class="row">
      <form  name="addproduct" action="product_form_edit_db.php" method="POST" enctype="multipart/form-data"  class="form-horizontal">
        ...
        <div class="col-sm-9">
            <p> Hot</p>
            <input type="text"  name="hot"  class="form-control" required placeholder="ราคาร้อน" value="<?=$hot; ?>" /> 
          </div>

          <div class="col-sm-9">
            <p> Cool</p>
            <input type="text"  name="cool"  <?php echo $cool; ?> class="form-control" required placeholder="ราคาเย็น" value="<?=$cool; ?>" />
          </div>
